...
# LOAD RESULTS ----
scenario_1 <- readRDS(here::here("results", "intermediate", "GSE202203_scenario1_results.rds"))
scenario_2 <- readRDS(here::here("results", "intermediate", "GSE202203_scenario2_results.rds"))
scenario_3 <- readRDS(here::here("results", "intermediate", "GSE202203_scenario3_results.rds"))
...
# w values after truncation
val_res$roc_w_boot632plus |> summary()
val_res$calslope_w_boot632plus |> summary()
...
# No need to set NA for null models, since test calibration slope for these models is NA
...
save.image(here::here("results", "intermediate", "GSE202203_binded_results.RData"))
